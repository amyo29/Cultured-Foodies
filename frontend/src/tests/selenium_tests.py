...
class Selenium_Tests(unittest.TestCase):
    ...
    def test_restaurants_page(self):
        ...
        self.driver.implicitly_wait(20)
        element = self.driver.find_elements_by_xpath(
            "/html/body/div/div/div/body/div[2]/div[2]/div/div[3]/table/tbody/tr[7]"
        )[0]
        self.driver.execute_script("arguments[0].click();", element)
        ...
        self.driver.implicitly_wait(20)
        element = self.driver.find_elements_by_xpath(
            "/html/body/div/div/div/body/div[2]/div[2]/div/div[3]/table/tbody/tr[1]"
        )[0]
        ...
        self.driver.implicitly_wait(20)
        element = self.driver.find_elements_by_xpath(
            "/html/body/div/div/div/body/div[2]/div[2]/div/table/tfoot/tr/td/div/div/div/div[3]/button[2]"
        )[0]
        self.driver.execute_script("arguments[0].click();", element)
